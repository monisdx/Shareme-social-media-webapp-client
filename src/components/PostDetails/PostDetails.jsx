...
const PostDetails = () => {
  ...
  return (
    ...
    <div className='top-[80px] px-2 sm:px-6 py-2 sm:py-6 mx-4 my-4 relative flex gap-4 flex-col overflow-hidden bg-black-100 rounded-[30px]'>
        ...
        <div className='flex flex-col p-5 justify-center '>
          ...
          <div className='flex flex-row mt-4 flex-wrap gap-8'>
            {recommendedPosts.map((recommendedPost) => (
              <div className='flex flex-col gap-2 w-[250px] justify-evenly' onClick={()=>openPost(recommendedPost._id)} key={recommendedPost._id}>
